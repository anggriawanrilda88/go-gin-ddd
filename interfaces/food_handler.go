...
import (
	...
	"net/http"
	"os"
	"pos/application/usecases"
	"pos/domain/entity"
	"pos/infrastructure/auth"
	"pos/interfaces/fileupload"
	"strconv"
	"time"
...
type Food struct {
	foodApp    usecases.FoodAppInterface
	userApp    usecases.UserAppInterface
...
//Food constructor
func NewFood(fApp usecases.FoodAppInterface, uApp usecases.UserAppInterface, fd fileupload.UploadFileInterface, rd auth.AuthInterface, tk auth.TokenInterface) *Food {
	return &Food{
		foodApp:    fApp,
		userApp:    uApp,
		fileUpload: fd,
