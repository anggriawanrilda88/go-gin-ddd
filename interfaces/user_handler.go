...
type Users struct {
	us usecases.UserAppInterface
	rd auth.AuthInterface
	tk auth.TokenInterface
}

//Users constructor
func NewUsers(us usecases.UserAppInterface, rd auth.AuthInterface, tk auth.TokenInterface) *Users {
	return &Users{
		us: us,
		rd: rd,
		tk: tk,
...
func (s *Users) GetUsers(c *gin.Context) {
	...
	var err error
	//us, err = usecases.UserApp.GetUsers()
	usersApp := usecases.NewUsers(s.us)
	users, err = usersApp.GetUsers()
	if err != nil {
